...
public class InstructionsActivity extends Activity implements
	...
	public void onCreate(Bundle state) {
        ...
        buttonPlayNow.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(InstructionsActivity.this, GameModeActivity.class);
	...
	private void stopListening() {
		...
		if(recognizerHypothesis == null) {
			Toast.makeText(getApplicationContext(),
					...
					.show();
			if(!(tries+1 == 3)) {
				textViewHowTo.setText("Opps... Try again. You can also "
		...
		if(strRecognized.equals(currWord) || strRecognized.contains(currWord)) {
			textViewHowTo.setText("Congratulations! You pronounced the word right!"
		...
		buttonPronounce.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				try {
				    ...
				    MusicManager.start(InstructionsActivity.this, MusicManager.MUSIC_ALL);
				} catch(Exception e) {
			    }
			}
		});
